...
const teamMembers = [
	{
		...
		bio: 'Postgraduate in biotechnology and PhD candidate at BITS Pilani. Leading innovation behind genetic compatibility matching.',
		socials: [
		...
		>
			...
			>
				...
				<div className='absolute top-20 right-20 opacity-20'>
					<Dna
						className='w-24 h-24 text-pink-300 animate-spin'
				...
				<div className='relative max-w-7xl mx-auto px-4 py-32 sm:py-40'>
					<div className='text-center'>
						<div className='mb-12'>
							...
							<p
								className='text-xl mb-16 max-w-3xl mx-auto leading-relaxed font-medium'
								style={{ color: '#444444' }}
							>
				...
				<div className='max-w-5xl mx-auto px-4'>
					<div className='text-center mb-20'>
						...
						<p
							...
							style={{ color: '#555555' }}
						>
							Our scientifically-proven process makes finding your
							compatible partner simple and reliable
						</p>
						<div
								...
								<div key={step.title} className='relative'>
									...
									>
										<div className='flex-shrink-0 relative'>
											{/* ICON CONTAINER */}
											<div
												className={`flex items-center justify-center w-20 h-20 rounded-3xl transition-all duration-500 ease-in-out ${
													isHovered
														? 'scale-110 rotate-6'
												...
												style={{
													background: isHovered
														...
														: '#FCCFE8',
													boxShadow: isHovered
														? '0 15px 30px rgba(252, 207, 232, 0.4)'
										...
										{/* TEXT CARD */}
										<div
											className={`flex-1 p-10 rounded-[2rem] border-2 transition-all duration-500 ease-in-out ${
												isHovered
											...
											style={{
												...
												borderColor: isHovered
													? '#FCCFE8'
													: 'rgba(252, 207, 232, 0.3)',
												color: '#222222',
												fontFamily:
													"'Inter', sans-serif",
												boxShadow: isHovered
													? '0 20px 40px rgba(252, 207, 232, 0.2)'
													: '0 10px 20px rgba(0,0,0,0.05)',
											}}
										>
											<div
												className='text-sm font-bold mb-3 tracking-wider uppercase transition-colors duration-300'
												style={{
													color: isHovered
														? '#222222'
														: '#DD9EC8',
										...
										<div className='flex justify-center my-8'>
											<div className='flex flex-col items-center'>
												...
												<div
													...
													style={{
														background:
															'linear-gradient(180deg, #FCCFE8 0%, transparent 100%)',
													}}
												></div>
											</div>
										</div>
					...
					<div className='flex justify-center'>
						{testimonials.map((testimonial) => (
							<div key={testimonial.name} className='max-w-3xl'>
								<div
									className='p-12 rounded-[2rem] shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-102 relative overflow-hidden'
									style={{
										background:
								...
								>
									<div
										...
										style={{
											background:
												'linear-gradient(90deg, #FCCFE8 0%, #222222 100%)',
										}}
									></div>
									...
									<blockquote className='text-xl italic leading-relaxed font-medium relative'>
										<span
											className='text-6xl absolute -top-4 -left-2 opacity-20'
											style={{ color: '#FCCFE8' }}
										>
											"
										</span>
										{testimonial.text}
										<span
											className='text-6xl absolute -bottom-8 -right-2 opacity-20'
											style={{ color: '#FCCFE8' }}
										>
											"
										</span>
							...
							>
								...
								>
									...
									<div className='text-center'>
										...
										<p
											className='font-bold text-lg mb-6 px-4 py-2 rounded-full inline-block'
											style={{
												color: '#ffffff',
												background: '#FCCFE8',
											}}
										...
										<p
											className='leading-relaxed mb-8 font-medium text-lg'
											style={{ color: '#555555' }}
										>
											{member.bio}
										</p>
